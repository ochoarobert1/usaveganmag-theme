...
add_action( 'after_setup_theme', 'PROYECTO_woocommerce_support' );
function PROYECTO_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'PROYECTO_woocommerce_custom_wrapper_start', 10);
