...
add_action( 'after_setup_theme', 'usaveganmag_woocommerce_support' );
function usaveganmag_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'usaveganmag_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'usaveganmag_woocommerce_custom_wrapper_end', 10);

function usaveganmag_woocommerce_custom_wrapper_start() {
...
function usaveganmag_woocommerce_custom_wrapper_end() {
